...
$bulletins = $pdo->select(
    ...
    WHERE students.matricule = 1094739550044");
dd($bulletins);
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-8 text-right">
                                ...
                                <h5 class="text-left"><strong >Nom & Prénom : </strong><?=$bulletin_de_note['nom'].' '. $bulletin_de_note['prenom'];?></h5>
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        foreach($bulletin_de_note['data']['code_matiere'] as $k => $v) :?>
                                            ...
                                            ?>
                                        <?php endforeach;?>
                                        <?php foreach($bulletin_de_note['data']['code_matiere'] as $k =>$v):?>
                                            <tr>
                                                <td> <?=$v;?></td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td><?= array_sum($bulletin_de_note['data']['coef_matiere']);?> </td>
                                            <td> <?= array_sum($MCC);?> </td>
                                            <td ><?= array_sum($bulletin_de_note['data']['note']['exam']);?></td>
                                            <td ><?=array_sum($MMat);?> </td>
                                            <td ><?=array_sum($mcoef);?> </td>
                                        </tr>
                                        <tr>
                                            <td colspan="5 " class="text-left"><strong>Moyenne Générale</strong></td>
                                            <td colspan="4 "><?= number_format(array_sum($mcoef) / array_sum($bulletin_de_note['data']['coef_matiere']),2) ;?> </td>
                                        </tr>
                                    </tfoot>
